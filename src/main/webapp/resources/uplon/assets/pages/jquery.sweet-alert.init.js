...
!function ($) {
    ...
    SweetAlert.prototype.init = function () {
        ...
        $('#sa-success').click(function () {
            swal("Pronto!", "Seu download já está sendo realizado", "success")
        });
        
        //Success Message Upload
        $('#sa-success-upload').click(function () {
            swal("Upload Realizado!", "Arquivo inserido com sucesso! Para consultá-lo, visite a página SGI e selecione o período referente ao arquivo", "success")
        });
